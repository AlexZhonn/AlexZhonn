...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Share+Tech+Mono&size=16&duration=2800&pause=900&color=7C4DFF&center=true&vCenter=true&width=520&lines=⚡+Building+Cr4ck+—+LeetCode+for+OOP;☁️+Learning+Kubernetes+%26+CI%2FCD;🎮+Top+1000+Valorant+%7C+Top+100+NBA+2K;👁+Sharingan+always+active;🔥+Avenger+of+O(n²)+algorithms)](https://git.io/typing-svg)
...
[![](https://visitcount.itsvg.in/api?id=AlexZhonn&icon=0&color=6)](https://visitcount.itsvg.in)
...
| Rank | Jutsu | Description |
|:----:|-------|-------------|
| **`S`** | 🧩 **Cr4ck — OOP Practice Platform** | LeetCode-style platform focused on OOP · currently in development |
| **`A`** | ⚡ **Full-Stack Web Apps** | Next.js + TypeScript · Supabase · deployed on AWS |
| **`A`** | ☁️ **DevOps Pipeline** | Kubernetes · CI/CD with GitHub Actions · Nginx reverse proxy |
| **`B`** | 📱 **Mobile Apps** | React Native · Expo · cross-platform shinobi tools |
...
<img height="165" src="https://github-readme-stats.vercel.app/api?username=AlexZhonn&theme=tokyonight&hide_border=false&include_all_commits=false&count_private=false" />
&nbsp;
<img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=AlexZhonn&theme=tokyonight&hide_border=false&include_all_commits=false&count_private=false&layout=compact" />
